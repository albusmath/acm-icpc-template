...
\lstinputlisting{code/link_cut_tree.cpp}
\subsection{KD Tree}
\lstinputlisting{code/k-dtree.cpp}
\subsection{Treap}
\lstinputlisting{code/treap.cpp}
\subsection{President Treap}
\lstinputlisting{code/president_treap.cpp}
\section{String Algorithms}
\subsection{Common}
\lstinputlisting{code/string.cpp}
\subsection{Aho-Crosick Automaton}
\lstinputlisting{code/ac_automaton.cpp}
\subsection{Suffix Array}
\lstinputlisting{code/suffix_array.cpp}
\section{Math}
\subsection{Gauss Elimiation}
\lstinputlisting{code/gauss_elimination.cpp}
\subsection{Matrix Inverse}
\lstinputlisting{code/Matrix_inverse.cpp}
...
\lstinputlisting{code/determinant.cpp}
...
\lstinputlisting{code/polynomial_root.cpp}
\subsection{Number Theory Library}
\lstinputlisting{code/number_theory.cpp}
\subsection{Number Partition} {
\lstinputlisting{code/partition.cpp}
\section{Computational Geometry}
\subsection{Common}
\lstinputlisting{code/computational_geometry/common.cpp}
\subsection{Graham Convex Hull}
\lstinputlisting{code/computational_geometry/graham_hull.cpp}
...
\lstinputlisting{code/computational_geometry/minkowski_convex_hull.cpp}
\subsection{Rotating Calipers}
\lstinputlisting{code/computational_geometry/rotating_caliper.cpp}
\subsection{Closest Pair Points}
\lstinputlisting{code/computational_geometry/closest_pair.cpp}
\subsection{Halfplane Intersection}
\lstinputlisting{code/computational_geometry/halfplane_intersection.cpp}
\lstinputlisting{code/computational_geometry/halfplane_intersection_nlogn.cpp}
\subsection{Tri-Cir Intersection \& Tangent}
\lstinputlisting{code/computational_geometry/circle_tangent.cpp}
\lstinputlisting{code/computational_geometry/circle_intersection.cpp}
\lstinputlisting{code/computational_geometry/triangle_circle_intersection.cpp}
\subsection{Circle Union}
\lstinputlisting{code/computational_geometry/circle_union.cpp}
\subsection{Minimum Covering Circle}
\lstinputlisting{code/computational_geometry/minimum_circle.cpp}
\subsection{Convex Polygon Union}
\lstinputlisting{code/computational_geometry/poly_union.cpp}
\subsection{3D Common}
\lstinputlisting{code/computational_geometry/common3d.cpp}
\subsection{3D Convex Hull}
\lstinputlisting{code/computational_geometry/hull3d.cpp}
\section{Graph}
\subsection{Tarjan}
...
\subsection{Max Flow}
\lstinputlisting{code/sap_maxflow.cpp}
...
\lstinputlisting{code/dominator_tree.cpp}
\section{Others}
% \subsection{Big Number}
% \lstinputlisting{code/big_number.cpp}
\subsection{Expr Parsing}
\lstinputlisting{code/expr_parse.cpp}
\subsection{Steiner's Problem}
\lstinputlisting{code/steiner.cpp}
\subsection{LCA}
\lstinputlisting{code/lca.cpp}
\subsection{Dancing Links X}
\lstinputlisting{code/dancing_links.cpp}
